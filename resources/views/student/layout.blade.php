                ...
                <div class=" ">
                    <div>
                        <div id="user-profile-1" class="user-profile row">
                            <div style="width:100%; padding-block:1.5rem; font-size:1.3rem; font-weight:600; padding-inline:2rem;" class="shadow bg-light mx-1">
                                ...
                                <hr>
                                <span class="d-block w-100 text-danger text-center" style="text-transform: uppercase;">To Enroll For Any Of The HDN Programs, YOU MUST HAVE A pass in at least two (2) A/L subjects ( excluding Religious Studies) in one sitting or 4 TVE subjects</span>
                            </div>
                        </div>
                    </div>
